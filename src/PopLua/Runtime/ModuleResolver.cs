...
/// <param name="load">Validated request with its normalized name, caller, depth, and observable step.</param>
/// <returns>
...
///     load.Name == "util" ? Chunk.Code("return { message = function() return 'ok' end }", "module:util.lua") : null));
/// </code>
/// </example>
