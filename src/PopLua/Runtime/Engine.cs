...
/// observers, and allocator settings. It does not own a Lua state; each
...
public sealed class Engine : IAsyncDisposable
{
    ...
    private readonly ObserverHub _observers;
    ...
    internal ObserverHub Observers => _observers;
    ...
    /// <summary>
    /// Creates a runtime with optional modules, services, observers, and allocator settings.
    /// </summary>
    /// <param name="configure">Optional callback used to register modules, services, observers, and allocator settings.</param>
    ...
    /// <param name="run">Logical host run, or an automatically generated run when omitted.</param>
