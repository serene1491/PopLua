...
public sealed class EngineBuilder
{
    ...
    private readonly List<IRunObserver> _observers = [];
    ...
    /// <summary>
    /// Adds a run observer used by sessions created from the runtime.
    /// </summary>
    /// <param name="observer">Observer that receives execution and controlled-loading events.</param>
    /// <returns>The current builder.</returns>
    ...
    /// </summary>
    /// <param name="resolver">Resolver that maps validated load requests to approved Lua chunks.</param>
    /// <returns>The current builder.</returns>
    /// <remarks>
    ...
    internal Engine Build()
        => new(_modules.Modules.ToArray(), _services, new ObserverHub(_observers.ToArray()), _allocator, _moduleResolver);
}
