...
/// <param name="Active">Time counted by the active-time quota.</param>
/// <param name="Suspended">Time spent suspended on async waits excluded from active-time accounting.</param>
/// <param name="Suspensions">Number of asynchronous suspensions.</param>
