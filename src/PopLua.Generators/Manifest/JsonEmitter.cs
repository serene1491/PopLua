...
internal static class JsonEmitter
{
    ...
    private static void WriteFunction(JsonWriter writer, FunctionModel function)
    {
        ...
        if (function.Overload > 0)
            writer.Property("overload", function.Overload);
        writer.PropertyIfNotNull("capability", function.Capability);
        writer.Property("async", function.IsAsync);
        if (function.IsAsync)
            writer.Property("countWait", function.CountWait);
    ...
    private static void WriteParameter(JsonWriter writer, ParameterModel parameter)
    {
        ...
        if (parameter.IsOptional)
            writer.Property("optional", true);
        if (parameter.CoercesText)
            writer.Property("text", true);
        writer.PropertyName("type");
