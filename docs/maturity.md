...
PopLua `1.0.0-rc.2` is release-candidate software. Lua-facing APIs are declared
...
by default and may opt into counting waits with `CountWait = true`. Arbitrary synchronous C#
